...
<head>
  ...
  <title>DePOS Admin - Dashboard</title>
  ...
  <!-- datatables -->
  <link rel="stylesheet" href="<?php echo get_template_directory('admin/vendor/datatables/dataTables.bootstrap4.min.css') ;?>">
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory('admin/admincss.css') ;?>">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">DePOS</div>
      </a>
      ...
      <?php if ($this->sess['level_admin'] == 'finance_admin'): ?>
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('admin/restaurant/detail/').$this->sess['id_restoran']?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?=$this->sess['foto_admin']?>">
              </a>
